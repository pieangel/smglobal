...
begin
  ...
  try
    ...
    begin
      ...
      begin
        Result := true;
        stLog  := Format('매수 손절 L_1 :  %.*n  < ( %.*n - %.*n )',[  iPre, aQuote.Last,
    ...
    begin
      ...
      begin
        Result := true;
        stLog  := Format('매도 손절 L_1 : %.*n  > ( %.*n + %.*n )',[  iPre, aQuote.Last,
            iPre, FEntryPrice, iPre, dVal ]);
      end;
    end;
    ...
    begin
      ...
      begin
        Result := true;
        stLog  := Format('매수 손절 L_2 :  %.*n  < ( %.*n - %.*n )',[  iPre, aQuote.Last,
            iPre, dH, iPre, dVal ]);
      end;
    end
    else begin
      ...
      begin
        Result := true;
        stLog  := Format('매도 손절 L_2 : %.*n  > ( %.*n + %.*n )',[  iPre, aQuote.Last,
            iPre, dL, iPre, dVal ]);
      end;
    end;
