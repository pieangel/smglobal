    ...
    FIsSucc: boolean;
{
  ...
  public
    ...
    RecoverFees : array [TDepositType] of Double;  // Recovery ºˆºˆ∑·
    OpenPL      : array [TDepositType] of double;

    ExchangeRate : array [TDepositType] of double;    // »Ø¿≤
    // øπºˆ±› ≥ªø™ ( ¥ﬁ∑Ø )
    LiquidPL     : array [TDepositType] of double;
    FixedPL      : array [TDepositType] of double;
    Deposit      : array [TDepositType] of double;    // ¿‘±›±›æ◊
    WonDaeAmt    : array [TDepositType] of double;
    DepositOTE   : array [TDepositType] of double;    // øπ≈π¿⁄ªÍ∆Ú∞°æ◊
    UnBackAmt    : array [TDepositType] of double;    // πÃºˆ±›æ◊;
    OrderAbleAmt : array [TDepositType] of double;    // ¡÷πÆ∞°¥…±›æ◊;

    TrustMargin  : array [TDepositType] of double;    // ¿ß≈π¡ı∞≈±›
    OrderMargin  : array [TDepositType] of double;    // ¡÷πÆ¡ı∞≈±›
    HoldMargin   : array [TDepositType] of double;    // ¿Ø¡ˆ¡ı∞≈±›
    AddMargin    : array [TDepositType] of double;    // √ﬂ∞°¡ı∞≈±›
    UnExcMargin  : array [TDepositType] of double ;   // πÃ∞·¡¶¡ı∞≈±›

    IsWriteFixedPL : array [TDepositType] of boolean;

    // RMS ∏¶ ¿ß«ÿ √ﬂ∞°
    LossCutAmt   : array [TDepositType] of double ;   // º’¿˝ ±›æ◊
    // «—µµ∞° µ∆¿Ω..
    BCutOff      : boolean;
