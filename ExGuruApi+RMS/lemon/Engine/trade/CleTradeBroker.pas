...
type
  ...
  public
    ...
    procedure UpdateOrd( aOrder : TOrder; anEventID: TDistributorID );
   ...
   //procedure Position( aOrder : TOrder; aInvest: TInvestor;
    ...
    procedure OrderResetNReload;
    procedure PositionResetNReload;
...
begin
  ...
  if (FTradeCore = nil) or (aOrder = nil) or ( aOrder.IsAccept ) then Exit;
...
procedure TTradeBroker.OrderResetNReload;
begin
  gEnv.Engine.TradeCore.Orders.OrderReSet;
  FDistributor.Distribute(Self, TRD_DATA, nil, ORDER_RELOAD);
end;

procedure TTradeBroker.PositionResetNReload;
begin
  gEnv.Engine.TradeCore.Positions.Reset;
  gEnv.Engine.TradeCore.InvestorPositions.Reset;
  gEnv.Engine.TradeCore.FundPositions.Reset;
  FDistributor.Distribute(Self, TRD_DATA, nil, POSITION_RELOAD);
end;

procedure TTradeBroker.UpdateOrd(aOrder: TOrder; anEventID: TDistributorID);
begin
  FDistributor.Distribute(Self, TRD_DATA, aOrder, anEventID);
end;
