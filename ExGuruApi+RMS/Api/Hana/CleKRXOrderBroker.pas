...
type
  ...
  public
    ...
    procedure RequestAccountData( aAccount: TAccount; aType : TApiEventType ); overload;
...
begin
  ...
  begin
    ...
    begin
      ...
      RequestAccountData( aInvest, rtDeposit );
...
begin
  ...
  begin
    ...
    begin
      RequestAccountData( aInvest, rtAcntPos );
      RequestAccountData( aInvest, rtActiveOrd );
    end;
  end;
...
begin
  ...
  {
  gEnv.EnvLog( WIN_PACKET,  Format('조회 : %s, %s, %s', [
    aAccount.Code, aAccount.Name, ApieEventName[ aType] ]) );
  }
