...
begin
  ...
  case (Sender as TComponent).Tag of
    ...
    203: gEnv.Engine.FormBroker.Open(ID_ACNT_PASSWORD, 0); //
      ...
      // trade
    301: gEnv.Engine.FormBroker.Open(ID_SINGLE_ORDERBOARD, 0); // simple order form
    ...
    412: gEnv.Engine.FormBroker.Open(ID_SINGLE_FUND_ORDERBOARD, 0);
...
begin
  ...
  case iFormID of
    ...
    ID_SINGLE_ORDERBOARD  :
      aForm := TSingleOrderBoardForm.Create(OrpMainForm);
