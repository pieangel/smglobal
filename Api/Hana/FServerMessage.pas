...
begin
  ...
  begin
    ...
    EnterCriticalSection( gAppLog.LogList[aKind].Critcal );

    for I := 0 to gAppLog.LogList[aKind].Count - 1 do
    begin

    aList := lvLog.Items.Insert(0);
    aItem := gAppLog.LogList[ aKind ].LogItem[i];
    ...
    gAppLog.LogList[aKind].Clear;

    LeaveCriticalSection( gAppLog.LogList[aKind].Critcal );
