...
const
  MARKET_TYPE_DESC: array[TMarketType] of String =
                 ('Not Assigned',
                  'Index', 'Stock', 'Bond', 'ETF', 'Futures', 'Options', 'ELW', 'Dollar',
...
type
  ...
  public
    ...
    function GetTickSize( dPrice : double ) : double;
...
function TMarketSpec.GetTickSize(dPrice: double): double;
var
  i : integer;
  aD: TTSizeDepth;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        aD  := FTSizes.Depths[i];
        if dPrice > aD.StartPrc - EPSILON then
        begin
          Result  := aD.Size;
          break;
        end;
