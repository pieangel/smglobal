...
uses
  Classes, SysUtils, dialogs, CleAccounts, ClePriceCrt, 
...
type
  ...
  public
    ...
    // 해외선물용..
    property PriceCrt : TPriceCrt read FPriceCrt write FPriceCrt;
      // names
    ...
    property PrevVolume: int64 read FPrevVolume write FPrevVolume;
      // 해외선물에서만 당일 새벽 시작가
    property DawnOpen: double read FDawnOpen write FDawnOpen;
  ...
  private
    ...
    procedure SetDspExpDate(const Value: string);
  protected
      // underlying
  ...
  public
    ...
    property DspExpDate : string read FDspExpDate write SetDspExpDate;
      // open interest info
...
procedure TDerivative.SetDspExpDate(const Value: string);
begin
  FDspExpDate := Format('%s.%s', [  Copy(Value, 1, 4), Copy(Value, 5, 2)]) ;
end;
