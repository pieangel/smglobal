...
type
  ...
  TBoardLogEvent = procedure( Sender : TObject; stTitle , stLog : string )of object;
  ...
  TOrderSpecies = ( opNormal, opVolStop, opProtecte, opBull, opStrangle, opYH,
                    opRatio, opStrangle2, opVolSpread, opInvestor, opTodarke,
                    opSheepBuy, opHULT, opHLT, opRatioS, opVols, opTrend, opOptHult, opTrend2, opBHult, opBHultOpt,
                    opEvolBHult ,opEvolHult, opPDT, opShortHult, opJarvis, opPave );

  TStrategyType = ( stNormal, stStrangle, stYH, stRatio, stStrangle2, stVolSpread,
                    stInvestor, stTodarke, stSheepBuy, stHult,
                    stRatioS, stVolS, stTrend, stOptHult, stTrend2, stBHult, stBHultOpt, stShortHult );
...
const
  ...
  WM_MAIN_MESSAGE   = WM_USER + $0005;

  WM_LIQSET_MESSAGE = WM_USER + $0005;
  WM_BOARD_CREATE   = WM_USER + $0006;
