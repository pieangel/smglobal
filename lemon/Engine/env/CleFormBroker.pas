  ...
  begin
    ...
    begin
      ...
      begin
        ...
        //aMenu.Add(FSubMenu);
        FForm := Result;
        if (FFormID = ID_ORDERBOARD) or
           (FFormID = ID_SINGLE_ORDERBOARD ) or
           (FFormID = ID_FUND_ORDERBOARD ) or
           (FFormID = ID_SINGLE_FUND_ORDERBOARD )
          then
        begin
    ...
    if (iFormID = ID_ORDERBOARD) or
       (iFormID = ID_SINGLE_ORDERBOARD ) or
       (iFormID = ID_FUND_ORDERBOARD ) or
       (iFormID = ID_SINGLE_FUND_ORDERBOARD ) then
      PostMessage( Result.Handle, WM_BOARD_CREATE, 0, 0 );
...
begin
  ...
  begin
    ...
    else if iFormID = ID_ACNT_PASSWORD then
    begin
      FStorage.Next;
      Continue;
    end;
    ...
    begin
      ...
      begin
        ...
        if aItem.FFormID <> ID_ACNT_DEPOSIT then
        ...
        if (aItem.FFormID = ID_ORDERBOARD) or
           (aItem.FFormID = ID_SINGLE_ORDERBOARD ) or
           (aItem.FFormID = ID_FUND_ORDERBOARD ) or
           (aItem.FFormID = ID_SINGLE_FUND_ORDERBOARD ) then
          PostMessage( aItem.FForm.Handle, WM_BOARD_CREATE, 0, 0 );  
