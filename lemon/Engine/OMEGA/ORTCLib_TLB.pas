...
// File generated on 2002-09-27 ¿ÀÈÄ 2:21:05 from Type Library described below.
...
// they can be used.                                                          
// ************************************************************************ //
// Type Lib: C:\Program Files\Omega Research\Program\Ortc.exe (1)
// IID\LCID: {67104EC1-03F1-11D3-8E10-00C04F68F811}\0
// Helpfile: 
// DepndLst: 
...
//   Hint: Symbol 'System' renamed to 'System_'
//   Hint: Symbol 'System' renamed to 'System_'
//   Error creating palette bitmap of (TMessageLogMessages) : Invalid GUID format
//   Error creating palette bitmap of (TATCCAlerts) : Invalid GUID format
//   Error creating palette bitmap of (TWAATCCAlerts) : Invalid GUID format
//   Error creating palette bitmap of (TSTCCOrders) : Invalid GUID format
// ************************************************************************ //
...
// *********************************************************************//
  IActiveOrders = interface(IDispatch)
    ...
    function  Add(const Symbol: WideString; const Description: WideString; 
                  ...
                  const Signal: WideString; const WorkSpace: WideString; 
                  const Interval: WideString; const PositionNumber: WideString; 
                  const OrderNumber: WideString; WindowID: Integer; nFlags: Integer; 
                  const AlertString: WideString): IDispatch; safecall;
    function  Fill(Item: OleVariant; FillPrice: Integer; FillBaseCode: Byte; 
                   SlippagePrice: Integer; SlippageBaseCode: Byte; Filled: TDateTime; 
...
// *********************************************************************//
  IActiveOrdersDisp = dispinterface
    ...
    function  Fill(Item: OleVariant; FillPrice: Integer; FillBaseCode: Byte; 
                   SlippagePrice: Integer; SlippageBaseCode: Byte; Filled: TDateTime; 
                   nFlags: Integer; const AlertString: WideString): IDispatch; dispid 2;
    function  Cancel(Item: OleVariant; Canceled: TDateTime; const CanceledNumber: WideString; 
...
// *********************************************************************//
  IOpenPositions = interface(IDispatch)
    ...
    function  Add(const Symbol: WideString; const Description: WideString; EntryPrice: Integer; 
                  EntryBaseCode: Byte; LastPrice: Integer; LastBaseCode: Byte; 
                  ProfitPrice: Integer; ProfitBaseCode: Byte; EntryTime: TDateTime; 
                  const System: WideString; const Signal: WideString; const WorkSpace: WideString; 
                  const Interval: WideString; const PositionNumber: WideString; 
                  const OrderNumber: WideString; WindowID: Integer; nFlags: Integer; 
                  const AlertString: WideString): IDispatch; safecall;
    procedure Remove(Item: OleVariant); safecall;
...
// *********************************************************************//
  ...
  TMessageLogMessagesAdd = procedure(Sender: TObject; var pDisp: OleVariant) of object;
  TMessageLogMessagesRemove = procedure(Sender: TObject; var pDisp: OleVariant) of object;
...
// *********************************************************************//
  ...
  TATCCAlertsAdd = procedure(Sender: TObject; var pDisp: OleVariant) of object;
  TATCCAlertsRemove = procedure(Sender: TObject; var pDisp: OleVariant) of object;
...
// *********************************************************************//
  ...
  TWAATCCAlertsAdd = procedure(Sender: TObject; var pDisp: OleVariant) of object;
  TWAATCCAlertsRemove = procedure(Sender: TObject; var pDisp: OleVariant) of object;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TMessageLogMessages, TATCCAlerts, TWAATCCAlerts, TSTCCOrders]);
end;
